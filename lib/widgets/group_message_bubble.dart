...
// A Group MessageBubble for showing a single chat message on the ChatScreen.
class GroupMessageBubble extends StatelessWidget {
  // Create a message bubble which is meant to be the first in the sequence.
  const GroupMessageBubble.first({
    super.key,
  ...
  // Controls how the GroupMessageBubble will be aligned.
  final bool isMe;
